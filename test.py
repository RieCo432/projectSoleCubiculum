...
living_room.hue_off()
time.sleep(2)
living_room.hue_span_color_cylce(living_room.build_list_horizontal_circle(), speed=50)
time.sleep(2)
living_room.hue_span_color_cylce(living_room.build_list_vertical_straight(), speed=20)
